 ...
 *
 * Uses Paper's modern io.papermc.paper.event.player.AsyncChatEvent rather
 * than the legacy org.bukkit.event.player.AsyncPlayerChatEvent, so this
 * keeps working correctly alongside signed/modern chat instead of relying
 * on Paper's legacy-compatibility bridge for the old Bukkit event.
 */
